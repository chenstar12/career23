...
- **微积分回忆**：求导公式、乘积法则、链式法则、隐函数求导、泰勒级数....

- **微分的概念全部包含于导数**，所有导数为 `df/dx` 形式，即**微商**；

## 推导圆的面积 - 积分的直观理解

圆的面积公式：[![](../_assets/公式_20180625144700.png)](http://www.codecogs.com/eqnedit.php?latex=Aera=\pi&space;R^2)
