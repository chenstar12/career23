...
- Kafka、ActiveMQ、RabbitMQ、RocketMQ 区别，适合哪些场景？

  

### 为什么使用消息队列

- 消息队列的使用场景？你项目里具体是什么场景？你在这个场景里的消息队列？

- **期望的回答**：你们公司有什么**业务场景**、技术挑战，如果不用 MQ 可能会很麻烦，用了 MQ 的好处？

消息队列常用场景，主要有 3 个：**解耦**、**异步**、**削峰**。

#### 解耦

看这么个场景。A 系统发送数据到 BCD 三个系统，通过接口调用发送。如果 E 系统也要这个数据呢？那如果 C 系统现在不需要了呢？A 系统负责人几乎崩溃......

<img src="./images/mq-1.png" alt="mq-1"  />
