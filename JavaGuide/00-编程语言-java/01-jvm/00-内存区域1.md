...
JVM 管理的最大内存、所有线程共享，JVM 启动时创建；

- **唯一作用：存放对象实例、数组**

- Java 堆是垃圾收集的主要区域，也称 **GC 堆（Garbage Collected Heap）**；现在都采用分代垃圾收集算法，堆还可以细分：新生代和老年代；目的是更好地回收/分配内存；

在 JDK 7 之前，堆内存分三部分：

1. 新生代内存(Young Generation)：Eden 区、两个 Survivor 区（S0 和 S1）
2. 老生代(Old Generation)
3. 永久代(Permanent Generation)

<img src="C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\hotspot-heap-structure.png" alt="hotspot-heap-structure" style="zoom:67%;" />

- **JDK 8 之后 PermGen(永久) 被 Metaspace(元空间) 取代，元空间用直接内存** ；
...
![HotSpot 虚拟机方法区的两种实现](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\method-area-implementation.png)
...
![](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\method-area-jdk1.6.png)

![](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\method-area-jdk1.7.png)

![](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\method-area-jdk1.8.png)
...
![对象的访问定位-使用句柄](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\对象的访问定位-使用句柄.png)

#### 直接指针

如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而 reference 中存储的直接就是对象的地址。

![对象的访问定位-直接指针](C:\Users\xin\Documents\career23\JavaGuide\00-编程语言-java\jvm\pictures\java内存区域\对象的访问定位-直接指针.png)
