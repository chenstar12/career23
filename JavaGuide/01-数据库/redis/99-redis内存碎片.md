...
例子：操作系统分配了 32 字节的连续内存空间，而存储数据实际只用 24 字节，多出来的 8 字节内存空间后续没有再分配

<img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/github/javaguide/memory-fragmentation.png" alt="内存碎片" style="zoom:67%;" />

Redis 内存碎片虽不影响性能，但会增加内存消耗；
